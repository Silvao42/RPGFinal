...
namespace WebCommerce.WebApi.Controllers
{
    ...
    public class MoedaInventarioController : ControllerBase
    {
        ...
        /// </returns>
        [HttpGet("todos")]
        public Task<List<MoedaInventario>> Todos() {
        ...
        /// <returns></returns>
        [HttpGet("ativos")]
        public IEnumerable<MoedaInventario> Ativos() => _moedaInventarioServico.ListarAtivos();
        ...
        [HttpDelete("excluir")]
        public NotificationResult Excluir(int CodJogador, int CodFicha, int CodMoeda)
        {
            return _moedaInventarioServico.Excluir( CodJogador, CodFicha, CodMoeda);
        }
